...
public class Funcionario {
	...
	//metodo executado apos um select
	@PostLoad
	public void carregarAposSelect() {
		System.out.println("Carregando o 13 salario...");
		
		Calendar hoje = Calendar.getInstance();
		
		//Valida se o funcionario entrou no ano
		if(hoje.get(Calendar.YEAR) == dataInicio.get(Calendar.YEAR)) {
